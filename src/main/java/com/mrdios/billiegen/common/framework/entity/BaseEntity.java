package com.mrdios.billiegen.common.framework.entity;
...
public class BaseEntity implements Serializable {
    ...
    @GenericGenerator(name = "billiegen-uuid-generator", strategy = "com.mrdios.billiegen.common.hibernate.BillieUUIDGenerator")
